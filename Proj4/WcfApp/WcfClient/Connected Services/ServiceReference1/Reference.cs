...
namespace WcfClient.ServiceReference1 {
    ...
    public interface ICalculator {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICalculator/PrimeCalculation", ReplyAction="http://tempuri.org/ICalculator/PrimeCalculationResponse")]
        Tuple<int, int> PrimeCalculation(int start, int end);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICalculator/PrimeCalculation", ReplyAction="http://tempuri.org/ICalculator/PrimeCalculationResponse")]
        System.Threading.Tasks.Task<Tuple<int, int>> PrimeCalculationAsync(int start, int end);
    ...
    public partial class CalculatorClient : System.ServiceModel.ClientBase<WcfClient.ServiceReference1.ICalculator>, WcfClient.ServiceReference1.ICalculator {
        ...
        public Tuple<int, int> PrimeCalculation(int start, int end) {
            return base.Channel.PrimeCalculation(start, end);
        }
        
        public System.Threading.Tasks.Task<Tuple<int,int>> PrimeCalculationAsync(int start, int end) {
            return base.Channel.PrimeCalculationAsync(start, end);
        }
