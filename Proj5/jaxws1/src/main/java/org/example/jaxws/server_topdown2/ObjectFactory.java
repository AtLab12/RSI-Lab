 ...
 * generated in the org.example.jaxws.server_topdown2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _UpdatePerson_QNAME = new QName("http://server.jaxws.example.org/", "updatePerson");
    private final static QName _UpdatePersonResponse_QNAME = new QName("http://server.jaxws.example.org/", "updatePersonResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.example.jaxws.server_topdown2
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://server.jaxws.example.org/", name = "updatePerson")
     ...
     */
    @XmlElementDecl(namespace = "http://server.jaxws.example.org/", name = "updatePersonResponse")
